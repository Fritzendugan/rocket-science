...
public class BodyWithActions extends BaseObject implements IUpdateHandler, ContactListener
{
	...
	public BodyWithActions(final MoveNode[] nodes, final Body b, final Shape s, final float av,
			               final boolean iss, final float dd, final long di, final short mk, final short rk) 
	{
		super(b,s,ObjectKeys.BODY_WITH_ACTIONS, mk, rk);
	...
	public String toString()
	{
		...
		buf.append(" --- BodyWithActions (myKey: ").append(myKey).append(") ---");
		...
		buf.append("\n --- end BodyWithActions (myKey: ").append(myKey).append(") ---");
		return buf.toString();
	}
